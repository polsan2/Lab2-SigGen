...
VL_INLINE_OPT void Vsigdelay___024root___nba_sequent__TOP__0(Vsigdelay___024root* vlSelf) {
    ...
    // Init
    SData/*8:0*/ __Vdly__sigdelay__DOT__wire1;
    __Vdly__sigdelay__DOT__wire1 = 0;
    ...
    // Body
    VL_WRITEF("%3#\n",8,vlSelf->mic_signal);
    __Vdly__sigdelay__DOT__wire1 = vlSelf->sigdelay__DOT__wire1;
    __Vdlyvset__sigdelay__DOT__myRam__DOT__ram_array__v0 = 0U;
    __Vdly__sigdelay__DOT__wire1 = ((IData)(vlSelf->rst)
                                     ? 0U : (0x1ffU 
                                             & ((IData)(1U) 
                                                + (IData)(vlSelf->sigdelay__DOT__wire1))));
    if (vlSelf->wr) {
    ...
    vlSelf->sigdelay__DOT__wire2 = (0x1ffU & ((IData)(vlSelf->sigdelay__DOT__wire1) 
                                              + (IData)(vlSelf->offset)));
    vlSelf->sigdelay__DOT__wire1 = __Vdly__sigdelay__DOT__wire1;
}
