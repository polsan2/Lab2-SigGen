...
void Vsigdelay___024root__trace_chg_sub_0(Vsigdelay___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        bufp->chgSData(oldp+0,((0x1ffU & (IData)(vlSelf->sigdelay__DOT____Vcellout__myCounter__count))),9);
        bufp->chgSData(oldp+1,(vlSelf->sigdelay__DOT__wire2),9);
        bufp->chgSData(oldp+2,(vlSelf->sigdelay__DOT____Vcellout__myCounter__count),10);
    }
    bufp->chgBit(oldp+3,(vlSelf->clk));
    bufp->chgBit(oldp+4,(vlSelf->rst));
    bufp->chgSData(oldp+5,(vlSelf->offset),9);
    bufp->chgBit(oldp+6,(vlSelf->wr));
    bufp->chgBit(oldp+7,(vlSelf->rd));
