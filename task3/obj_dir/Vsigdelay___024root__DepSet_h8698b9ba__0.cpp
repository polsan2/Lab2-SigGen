...
VL_INLINE_OPT void Vsigdelay___024root___nba_sequent__TOP__0(Vsigdelay___024root* vlSelf) {
    ...
    // Init
    SData/*9:0*/ __Vdly__sigdelay__DOT____Vcellout__myCounter__count;
    __Vdly__sigdelay__DOT____Vcellout__myCounter__count = 0;
    SData/*8:0*/ __Vdlyvdim0__sigdelay__DOT__myRam__DOT__ram_array__v0;
    __Vdlyvdim0__sigdelay__DOT__myRam__DOT__ram_array__v0 = 0;
    CData/*7:0*/ __Vdlyvval__sigdelay__DOT__myRam__DOT__ram_array__v0;
    __Vdlyvval__sigdelay__DOT__myRam__DOT__ram_array__v0 = 0;
    CData/*0:0*/ __Vdlyvset__sigdelay__DOT__myRam__DOT__ram_array__v0;
    __Vdlyvset__sigdelay__DOT__myRam__DOT__ram_array__v0 = 0;
    // Body
    VL_WRITEF("%3#\n",8,vlSelf->mic_signal);
    __Vdly__sigdelay__DOT____Vcellout__myCounter__count 
        = vlSelf->sigdelay__DOT____Vcellout__myCounter__count;
    __Vdlyvset__sigdelay__DOT__myRam__DOT__ram_array__v0 = 0U;
    __Vdly__sigdelay__DOT____Vcellout__myCounter__count 
        = ((IData)(vlSelf->rst) ? 0U : (0x3ffU & ((IData)(1U) 
                                                  + (IData)(vlSelf->sigdelay__DOT____Vcellout__myCounter__count))));
    if (vlSelf->wr) {
        ...
        __Vdlyvdim0__sigdelay__DOT__myRam__DOT__ram_array__v0 
            = (0x1ffU & (IData)(vlSelf->sigdelay__DOT____Vcellout__myCounter__count));
    }
    if (vlSelf->rd) {
        vlSelf->delayed_signal = vlSelf->sigdelay__DOT__myRam__DOT__ram_array
            [vlSelf->sigdelay__DOT__wire2];
    }
    ...
    vlSelf->sigdelay__DOT__wire2 = (0x1ffU & ((IData)(vlSelf->sigdelay__DOT____Vcellout__myCounter__count) 
                                              + (IData)(vlSelf->offset)));
    vlSelf->sigdelay__DOT____Vcellout__myCounter__count 
        = __Vdly__sigdelay__DOT____Vcellout__myCounter__count;
}
