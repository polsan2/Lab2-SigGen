...
VL_INLINE_OPT void Vsinegen___024root___nba_sequent__TOP__0(Vsinegen___024root* vlSelf) {
    ...
    // Init
    CData/*7:0*/ __Vdly__sinegen__DOT__adress;
    __Vdly__sinegen__DOT__adress = 0;
    // Body
    __Vdly__sinegen__DOT__adress = vlSelf->sinegen__DOT__adress;
    if (vlSelf->rst) {
        __Vdly__sinegen__DOT__adress = 0U;
    }
    if (vlSelf->en) {
        __Vdly__sinegen__DOT__adress = (0xffU & ((IData)(vlSelf->sinegen__DOT__adress) 
                                                 + (IData)(vlSelf->incr)));
    }
    vlSelf->dout = vlSelf->sinegen__DOT__myRom__DOT__rom_array
        [vlSelf->sinegen__DOT__adress];
    vlSelf->sinegen__DOT__adress = __Vdly__sinegen__DOT__adress;
}
